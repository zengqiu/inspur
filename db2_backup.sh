...
if [ "x$ret" = "x" ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        find /db2log/db2inst1/ECGAP/NODE0000/C0000010 -ctime +14 -exec rm -rf {} \;
    else
    ...
    if [ $? -eq 0 ]; then
        ...
        find /db2log/db2inst1/ECGAPOUT/NODE0000/C0000005 -ctime +14 -exec rm -rf {} \;
    else
    ...
    if [ $? -eq 0 ]; then
        ...
        find /db2log/db2inst1/EMONITOR/NODE0000/C0000008 -ctime +14 -exec rm -rf {} \;
    else
    ...
    if [ $? -eq 0 ]; then
        ...
        find /db2log/db2inst1/MIDDLE/NODE0000/C0000005 -ctime +14 -exec rm -rf {} \;
    else
    ...
    if [ $? -eq 0 ]; then
        ...
        find /db2log/db2inst1/PERFORM/NODE0000/C0000005 -ctime +14 -exec rm -rf {} \;
    else
